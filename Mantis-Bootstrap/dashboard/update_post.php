  ...
  if(isset($_POST['update']))
  {
    ...
    //   $updated_at = trim($_POST['updated_at']);
      ...
      if (strlen($post_title) < 3) {
        die("<p style='color:red;'>Post Title must be at least 3 characters long.</p>");
      }

      if (strlen($post_description) < 3) {
        die("<p style='color:red;'>POST Description must be at least 3 characters long.</p>");
      }

      $query = "UPDATE post SET image = '$folder', post_title='$post_title', post_description='$post_description' WHERE id='$uid'";
        ...
        {   
          ?>
        <meta http-equiv = "refresh" content = "2; url = http://localhost/1.%20AORC%20TECHNOLOGIES/PRACTICE/7.crud_html/Mantis-Bootstrap/dashboard/allpost.php" />
          ...
          <div class="card-body">
            ...
            <!-- <div class="row"> -->
              <div class="col-md-12">  
                ...
                <img src="<?php echo $result['image']; ?>" alt="Profile Image" width="100"><br>

                  <label class="form-label">Your Photo: </label>
                  <input type="file" id="imageInput" name="image" value="<?php echo $result['image'] ?>" accept=".jpg, .jpeg, .png" class="form-control" >
              ...
              <div class="col-md-12">
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control" value="<?php echo $result['post_title']?>" name="post_title" placeholder="Enter post Title">
                </div>
              </div>
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" placeholder="Enter Your Description" value="<?php echo $result['post_description']?>" name="post_description">
            </div>

            <!-- <p class="mt-4 text-sm text-muted">By Signing up, you agree to our <a href="#" class="text-primary"> Terms of Service </a> and <a href="#" class="text-primary"> Privacy Policy</a></p> -->
            <div class="d-grid mt-3">
              <a href="index.php"><button type="submit" class="btn btn-primary" name = "update">UPDATE POST</button></a>
              <br>
              <a href="allpost.php">Back</a>
            </div>
